...
export const BarbeirosPage: React.FC = () => {
  ...
  return (
    <div className="pb-24 pt-2 px-4 max-w-3xl mx-auto space-y-6">
      ...
      {/* Barbers List */}
      {barbers.length === 0 ? (
        <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-8 text-center space-y-4">
          <div className="w-14 h-14 rounded-full bg-neutral-800 flex items-center justify-center mx-auto text-amber-400">
            <Users className="w-7 h-7" />
          </div>
          <div>
            <h3 className="text-base font-bold text-white font-mono">Nenhum Barbeiro Cadastrado</h3>
              ...
              <div>
                ...
                <div className="relative h-48 bg-neutral-950">
                  ...
                  <div className="absolute top-3 right-3 bg-black/80 backdrop-blur-md text-amber-400 text-xs font-bold font-mono px-2.5 py-1 rounded-lg border border-amber-500/30 flex items-center gap-1">
                    ...
                    <span>{barber.rating || 5.0} ({barber.reviewsCount || 0})</span>
                  </div>
                </div>
